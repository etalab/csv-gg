...
<div>
    ...
    <div  class="rf-container rf-pb-1w rf-pt-2w">
        ...
        <br />
        <div style="min-height: 270px;" class="rf-callout rf-fi-information-line rf-callout--scheme-soft-blue-soft rf-mb-3w">
            <p>{{ messageInfo }}</p>
            <p>{{ exempleInfo }}</p>
            <p v-if="warningInfo != ''" class='warningInfo'>{{ warningInfo }}</p>
            <p v-if="errorInfo != null & errorInfo != ''" class='errorInfo'>Message d'erreur : {{ errorInfo }}</p> 
        </div>
    </div>
    ...
    <div  class="rf-container">
        <button style="margin-right: 20px" @click="submit()" type="submit" class="rf-btn">Valider le fichier</button>
        <button style="margin-right: 20px" class="rf-btn" v-if="publicationButtons" @click="csvLinkData">Télécharger le CSV</button>
        <button style="margin-right: 20px" class="rf-btn" v-if="publicationButtons" @click="showPublishForm()">Publier sur data.gouv.fr</button>
    </div>
